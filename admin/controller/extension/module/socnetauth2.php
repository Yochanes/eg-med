...
class ControllerExtensionModulesocnetauth2 extends Controller {
	...
	public function install()
	{
		...
		$this->model_setting_extension->install('module', 'socnetauth2_popup');
		...
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/socnetauth2_popup');
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/socnetauth2_popup');	
	}
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) 
		{
			...
			$this->model_setting_setting->editSetting('module_socnetauth2', array('module_socnetauth2_status' => $this->request->post['socnetauth2_status']));
			$this->model_setting_setting->editSetting('module_socnetauth2_popup', array('module_socnetauth2_popup_status' => $this->request->post['socnetauth2_popup_status']));		
			...
			if( !empty($this->request->post['stay']) )
			{
				...
				$this->response->redirect($this->url->link('extension/module/socnetauth2', 'user_token=' . $this->session->data['user_token'].'&tab='.$tab, true));
			}
			else
			{
		...
		$this->data['vkontakte_retargeting'] = $this->url->link('extension/module/socnetauth2/vkontakte_retargeting', 'user_token=' . $this->session->data['user_token'], true);
		$this->data['facebook_retargeting'] = $this->url->link('extension/module/socnetauth2/facebook_retargeting', 'user_token=' . $this->session->data['user_token'], true);
 		...
 		if (isset($this->error['warning'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/socnetauth2', 'user_token=' . $this->session->data['user_token'], true),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('extension/module/socnetauth2', 'user_token=' . $this->session->data['user_token'], true);
	...
	public function vkontakte_retargeting()
	{
		...
		$filename = 'vkontakte_retargeting.txt';       
	...
	public function facebook_retargeting()
	{
		...
		$filename = 'facebook_retargeting.txt';        
		header('Pragma: public');
		header('Expires: 0');
		header('Cache-Control: must-revalidate, post-check=0, pre-check=0');
		header('Cache-Control: private', false); 
