<?php
// Heading
$_['page_title']       = 'Авторизация через соцсети';
...
$_['entry_shop_folder']		= 'Директория магазина из домена:';
$_['help_shop_folder']		= 'Если в домене Вашего магазина есть директория, например: http://site.ru/shop/ то укажите название директории shop без знаков слэш /. Если же в домене вашего магазина нет директории, например http://site.ru - то оставьте это поле пустым.';
...
$_['tab_gmail'] = 'Google';
$_['entry_gmail_status'] = 'Авторизация через Google:';
...
$_['entry_format']		  = 'Вид кнопок:';
$_['text_format_kvadrat'] = 'Квадрат с крупными значками';
...
$_['text_contact']	  = '<a href="https://opencart3x.ru">opencart3x.ru</a>';

$_['text_country'] 		 = 'Страна';
$_['text_regions'] 		 = 'Регионы';
