...
class ModelExtensionModuleSocnetauth2 extends Model 
{
	...
	public function makeCode($data)
	{
		...
		$data['socnetauth2_confirm_block'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_confirm', $template_data);
		
		$template_data['socnetauth2_format'] = 'kvadrat';
		
		$data['socnetauth2_reg_code_kvadrat'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_reg', $template_data);
		$data['socnetauth2_simplereg_code_kvadrat'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_simplereg', $template_data);
		$data['socnetauth2_simple_code_kvadrat']    = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_simple', $template_data);
		$data['socnetauth2_account_code_kvadrat']   = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_account', $template_data);
		$data['socnetauth2_checkout_code_kvadrat']  = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_checkout', $template_data);
		
		$template_data['socnetauth2_format'] = 'bline';
		
		$data['socnetauth2_reg_code_bline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_reg', $template_data);
		$data['socnetauth2_simplereg_code_bline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_simplereg', $template_data);
		$data['socnetauth2_simple_code_bline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_simple', $template_data);
		$data['socnetauth2_account_code_bline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_account', $template_data);
		$data['socnetauth2_checkout_code_bline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_checkout', $template_data);
		
		$template_data['socnetauth2_format'] = 'lline';
		
		$data['socnetauth2_reg_code_lline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_reg', $template_data);
		$data['socnetauth2_simplereg_code_lline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_simplereg', $template_data);
		$data['socnetauth2_simple_code_lline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_simple', $template_data);
		$data['socnetauth2_account_code_lline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_account', $template_data);
		$data['socnetauth2_checkout_code_lline'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_checkout', $template_data);
	...
	public function showData()
	{
		...
		elseif( $this->request->get['route']=='customer/customer' )
		{
			$tab = 'customer_list';
			$customer_id = '';
		...
		elseif( $tab == 'customer_list' )
		{
			...
			$customer_total = $this->model_customer_customer->getTotalCustomers($data_filter);
	
			$results = $this->model_customer_customer->getCustomers($data_filter);
	...
	public function showData2()
	{
		...
		elseif( $tab == 'order_list' )
		{
			...
			foreach($results as $res)
			{
				...
				if( !empty($order['customer_id']) )
				{
					$cust = $this->model_customer_customer->getCustomer( $order['customer_id'] );
